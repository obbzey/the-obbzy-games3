...
const CHALLENGES = {
  ...
  2: {
    ...
    steps: [
      ...
      },
      {
        ...
        options: ['The unspoken plan', 'Over stimulation', 'Annoyance Overload', 'Performance Fatigue'],
        correct: 3,
        feedback_correct: '✅ 🌈🦋💜 ',
        feedback_wrong: '❌ It\'s 🌈🦋💜',
      },
    ...
    steps: [
      {
        ...
        correct: 2,
        feedback_correct: '✅ "Like" she says it like a hundred times a day',
  ...
  4: {
    ...
    steps: [
      {
        type: 'music_choice',
        question: 'Classic Arabic legends face off! Which artist does she prefer?',
        options: [
  ...
  5: {
    ...
    steps: [
      {
        type: 'multiple_choice',
        question: 'Be honest — what\'s her signature filler word that everyone notices?',
        options: ['Literally', 'Like', 'I mean', 'You know'],
        correct: 1,
        feedback_correct: '✅ "LIKE" she says it, like constantly.',
        feedback_wrong: '❌ It\'s "Like"! Like you should\'ve seen this coming, come on now',
      },
      {
        type: 'music_choice',
